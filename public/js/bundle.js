      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error in logged out. Try again.');
          case 10:
          case "end":
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFzaGVteW91c2VmaSIsImEiOiJjbDlyYjg4NnoxYmJvM3BvNm82anJscTluIn0.xFGtuXO5IJqWNYphk0xDBA';
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51Mcr4MLEsqOvO4yuhWOtbApkV5uPx1tQJShoIhFVPOcy3yk0bMO0xA1bX1NgYi0qBAhdqyokGXByV847db7XrrX700PZ4ElqiR');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://127.0.0.1:3000/api/v1/booking/checkout-session/".concat(tourId));
          case 3:
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var passwordCurrentDOM, passwordDOM, passwordConfirmDOM, currentPassword, newPassword, newPasswordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              passwordCurrentDOM = document.getElementById('password-current');
              passwordDOM = document.getElementById('password');
              passwordConfirmDOM = document.getElementById('password-confirm');
              e.preventDefault();
              currentPassword = passwordCurrentDOM.value;
              newPassword = passwordDOM.value;
              newPasswordConfirm = passwordConfirmDOM.value;
